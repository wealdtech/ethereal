...
// RegistrarContract obtains the registrar contract for a given domain
func RegistrarContract(client *ethclient.Client, domain string) (registrar *registrarcontract.RegistrarContract, err error) {
